///scr_allocate_skill_points(x,y,class)
var xx = argument0;
var yy = argument1;
    ...
    case "Mage":
        switch(yy)
        {
            ...
            case 3:
                 ...
                 {
                     case 0:
                     obj_player_parent.bground_slow = true;
                     break;
                     case 1:
                     obj_player_parent.bground_damage_increased+=0.3;
                     break;
            ...
            case 4:
                 switch(xx)
                 {
                     ...
                     break;
                     case 8:
                     obj_player_parent.flameblast_fireball_proc = true;
                     break;
                 }
            break;
            case 5:
            ...
            case 6:
                 switch(xx)
                 {
                     ...
                     break;
                     case 8:
                     obj_player_parent.flameblast_spawn_bground=true;
                     break;
                 }
            break;
            case 7:
                 ...
                 {
                     case 1:
                     obj_player_parent.blink_buff = true;
                     break;
                     case 2:
                     obj_player_parent.bground_radius_more+=0.3
                     scr_calc_bground_radius_total();
            ...
            case 8:
                 ...
                 {
                     case 6:
                     obj_player_parent.tower_recharge_buff = true;
                     break;
                 }
            break;       
        }
